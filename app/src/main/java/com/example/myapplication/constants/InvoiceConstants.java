...
public class InvoiceConstants {
    ...
    static {
        ...
        priceMap.put("PINEAPPLE SODA", InvoiceConstants.PINEAPPLE_SODA);
    ...
    private static final int SODA_SARBAT_RATE = 25;
    private static final int WALA_RATE = 20;
    private static final int JEERA_SODA_RATE = 20;
    private static final int LIMBU_SODA = 20;
    private static final int STRAWBERRY_SODA = 25;
    private static final int PINEAPPLE_SODA = 25;
    ...
    private static final int MANGO_LASSI_HALF_RATE = 30;
    private static final int MANGO_LASSI_FULL_RATE = 60;
